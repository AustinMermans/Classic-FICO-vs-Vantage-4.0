...
> **Archived Part 1 gallery.** These figures compare only Classic FICO and VantageScore 4.0. The
> current three-score gallery is [here](GALLERY.md).

Extra views from the original analysis. The writeup is in [Part 1](PART1.md); the methods and exact
numbers are in the [Part 1 report](PART1_REPORT.md).
