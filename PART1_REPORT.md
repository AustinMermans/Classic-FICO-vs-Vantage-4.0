...
> **Archived Part 1 report.** Its statements about FICO 10T availability describe the data
> available when this analysis was written. The completed three-score follow-up is in the current
> [README](README.md), [REPORT](REPORT.md), and [GALLERY](GALLERY.md).
